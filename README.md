...
Luu y: file src/main/resources/application.properties dang bi ignore tren Git.
Hay tao file local theo mau duoi day:
...
2. Tao file src/main/resources/application.properties theo mau o tren.
